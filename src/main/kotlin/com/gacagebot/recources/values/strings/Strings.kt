...
class Strings {
    ...
    companion object {
        const val first_join_server_message: String = "!!! Salve Rapeize !!!"
        const val voice_channel_join_denied_message: String = "Não tenho permissão para entrar nessa canal de voz"
        const val already_joined_in_voice_channel_message: String = "Voce não ta em conectado em um canal de voz BURRO"
